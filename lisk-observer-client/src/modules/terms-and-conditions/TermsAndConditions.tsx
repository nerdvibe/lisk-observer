        ...
        <Row>
          <Col md="12">
            <Card>
              ...
              <CardBody className="tc-container">
                <h3 className="white-text">TERMS OF USE</h3>
                <hr />
                <p>Last updated January 20, 2022</p>
                <h3 className="white-text">AGREEMENT TO TERMS</h3>
                <hr />
                <p>
                  These Terms of Use constitute a legally binding agreement made
                  between you, whether personally or on behalf of an entity
                  (“you”) and WeStake.club ("Company", “we”, “us”, or “our”),
                  ...
                  of and to have accepted, the changes in any revised Terms of
                  Use by your continued use of the Site after the date such
                  revised Terms of Use are posted. The information provided on
                ...
                <h3 className="white-text">INTELLECTUAL PROPERTY RIGHTS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">USER REPRESENTATIONS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">USER REGISTRATION</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">PROHIBITED ACTIVITIES</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">USER GENERATED CONTRIBUTIONS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">CONTRIBUTION LICENSE</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">SUBMISSIONS</h3>
                <hr />
                <p>
                  ...
                  THIRD-PARTY WEBSITE AND CONTENT The Site may contain (or you
                ...
                <h3 className="white-text">ADVERTISERS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">SITE MANAGEMENT</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">PRIVACY POLICY</h3>
                <hr />
                <p>
                  ...
                  advised the Site is hosted in EU. If you access the Site from
                  any other region of the world with laws or other requirements
                  governing personal data collection, use, or disclosure that
                  differ from applicable laws in EU, then through your continued
                  use of the Site, you are transferring your data to EU, and you
                  agree to have your data transferred to and processed in EU.
                </p>
                <h3 className="white-text">TERM AND TERMINATION</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">MODIFICATIONS AND INTERRUPTIONS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">GOVERNING LAW</h3>
                <hr />
                <p>
                  These terms and conditions are governed by and construed in
                  accordance with the laws of Italy and you irrevocably submit
                  to the exclusive jurisdiction of the courts in that State or
                  location.
                </p>
                <h3 className="white-text">DISPUTE RESOLUTION</h3>
                <hr />
                <p>
                  Binding Arbitration Any dispute arising from the relationships
                  between the parties to this contract shall be determined by
                  one arbitrator who will be chosen in accordance with the
                  Arbitration and Internal Rules of the European Court of
                  Arbitration being part of the European Centre of Arbitration
                  having its seat in Strasbourg, and which are in force at the
                  time the application for arbitration is filed, and of which
                  adoption of this clause constitutes acceptance. The seat of
                  arbitration shall be Portugal. The language of the proceedings
                  shall be english. Applicable rules of substantive law shall be
                  the law of Portugal. Restrictions The Parties agree that any
                ...
                <h3 className="white-text">CORRECTIONS</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">DISCLAIMER</h3>
                <hr />
                <p>
                  ...
                  JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE. LIMITATIONS
                  OF LIABILITY IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES,
                  ...
                  LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $0.00 USD.
                ...
                <h3 className="white-text">INDEMNIFICATION</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">USER DATA</h3>
                <hr />
                <p>
                ...
                <h3 className="white-text">MISCELLANEOUS</h3>
                <hr />
                <p>
                  ...
                  by the parties hereto to execute these Terms of Use. CONTACT
                  US In order to resolve a complaint regarding the Site or to
                  receive further information regarding use of the Site, please
                  contact us at: devnull [ a t ] WeStake.club
                </p>
              </CardBody>
            </Card>
          </Col>
